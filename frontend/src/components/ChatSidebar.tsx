  ...
  return (
    ...
    <div className={`border-r border-[var(--gray-200)] bg-[var(--gray-50)] h-full flex flex-col p-4 shrink-0 transition-all duration-300 ${isMinimized ? 'w-16 items-center' : 'w-64'}`}>
      ...
      {deletingId && (
        ...
        >
          <div 
            className="bg-white p-6 rounded-xl shadow-xl max-w-sm w-full m-4 border border-[var(--gray-200)]" 
            onClick={e => e.stopPropagation()}
          >
            <h3 className="text-lg font-semibold text-[var(--gray-900)] mb-2">Delete Chat</h3>
