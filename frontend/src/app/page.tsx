...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      {/* Header */}
      <header className="sticky top-0 z-50 w-full border-b border-[var(--gray-200)] bg-white/80 backdrop-blur-md">
      ...
      <main className="flex-1 flex flex-col items-center">
        ...
        <section className="w-full pt-32 pb-24 px-6 relative overflow-hidden flex flex-col items-center text-center">
          ...
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto animate-slide-up" style={{ animationDelay: '300ms' }}>
              ...
              <Link href="#how-it-works" className="w-full sm:w-auto flex items-center justify-center px-8 py-4 rounded-xl text-lg font-semibold text-[var(--gray-700)] bg-white border border-[var(--gray-200)] hover:bg-[var(--gray-50)] active:scale-95 transition-all shadow-sm">
                How it works
              </Link>
            </div>
            ...
            <div className="mt-12 flex items-center gap-4 text-sm text-[var(--gray-400)] animate-slide-up" style={{ animationDelay: '400ms' }}>
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-[var(--gray-200)] flex items-center justify-center text-[10px] text-[var(--gray-500)] font-medium">
        ...
        {/* Features Section */}
        <section className="w-full py-24 bg-[var(--gray-50)] px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="bg-white p-8 rounded-2xl border border-[var(--gray-200)] shadow-sm hover:shadow-md transition-shadow hover:-translate-y-1 duration-200">
        ...
        {/* CTA Section */}
        <section className="w-full py-24 px-6 bg-white border-t border-[var(--gray-200)]">
          <div className="max-w-4xl mx-auto bg-[var(--brand-50)] rounded-3xl p-12 text-center border border-[var(--brand-200)]">
      ...
      {/* Footer */}
      <footer className="w-full border-t border-[var(--gray-200)] bg-white py-12 px-6">
