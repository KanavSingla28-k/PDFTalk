  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full`}>
      <body className="min-h-full flex items-center justify-center bg-[var(--gray-50)] p-6">
        <div className="flex w-full max-w-md flex-col items-center justify-center rounded-2xl border border-[var(--error-200)] bg-white p-8 text-center shadow-lg">
          ...
          <div className="flex w-full flex-col gap-3">
            ...
            <button
              ...
              className="w-full rounded-xl border border-[var(--gray-300)] bg-white px-4 py-2.5 text-sm font-semibold text-[var(--gray-700)] transition-colors hover:bg-[var(--gray-50)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--brand-500)]"
            >
              Return to home
            </button>
          </div>
